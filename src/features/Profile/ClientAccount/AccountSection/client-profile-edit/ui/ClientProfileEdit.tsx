            ...
            <div className="flex flex-col gap-[26px] lg:flex-row lg:items-stretch">
                ...
                <div className="flex min-w-0 flex-1 flex-col gap-3">
                    <AccountField className="rounded-[16px] px-5 py-0">
                        <AccountInput placeholder="ФИО" className="text-[16px] font-normal leading-[140%] placeholder:text-[#c5c2c2]" />
                    </AccountField>
                    <AccountField className="rounded-[16px] px-5 py-0">
                        <AccountInput placeholder="Город" className="text-[16px] font-normal leading-[140%] placeholder:text-[#c5c2c2]" />
                    </AccountField>
                </div>
            </div>
        </AccountFormBlock>
