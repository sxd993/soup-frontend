...
import { OrderFindFiltersSkeleton } from "./OrderFindFiltersSkeleton";
import { OrderFindRegionsSkeleton } from "./OrderFindRegionsSkeleton";

export const OrderFindFilters = () => {
  const {
    openSectionIds,
    toggleSection,
    sections,
    ...
    <aside className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        ...
        <StateProvider
          ...
          loadingComponent={<OrderFindRegionsSkeleton />}
        >
      ...
      <div className="flex flex-col gap-4">
        ...
        <StateProvider
          ...
          errorTitle="Не удалось загрузить фильтры"
          loadingComponent={<OrderFindFiltersSkeleton />}
        >
          <div className="flex flex-col gap-2">
