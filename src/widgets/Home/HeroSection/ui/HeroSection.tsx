  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex py-[5%] justify-between px-4 mt-20">
        {/* Левая часть */}
        <div className="flex-1 flex items-center justify-start lg:justify-center max-w-full">
          <div className="h-full flex flex-col gap-5 justify-start sm:items-start sm:justify-start">
            ...
            {/* Кнопка */}
            <div className='flex-1 flex items-start lg:items-end'>
