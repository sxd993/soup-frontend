  ...
  return (
    <div className="rounded-[30px] bg-white p-6">
      ...
      <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:items-center">
        <Button
          className="flex h-12 w-full items-center justify-center rounded-full bg-primary! text-accent-senary! hover:bg-accent! active:bg-[#80D62C]! disabled:bg-[#D3EBBB]! sm:w-[180px]"
          onClick={onCall}
          disabled={!canCall}
        >
          Позвонить
        ...
        <Button
          className="flex h-12 w-full items-center justify-center whitespace-nowrap rounded-full bg-accent-septenary! text-white! hover:bg-secondary! active:bg-[#201F1F]! disabled:bg-[#C5C2C2]! sm:w-[260px]"
        >
          Предложить заказ
        </Button>
      </div>
